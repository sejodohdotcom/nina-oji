...
var countDownDate = new Date("Jun 04, 2022 07:00:00").getTime();
...
$(document).ready(function() {
    ...
    document.querySelector("#share-lock").onclick = function() {
        window.open('https://maps.app.goo.gl/uXbPDW74KP9j1Yjg8', '_blank'); 
    };
    ...
    function loadContent() {
        ...
        var url = "https://api.npoint.io/5f9827840858b17d530c";
        ...
        xhr.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                localStorage.setItem("messagesData30c", this.responseText);
    ...
    function loadRSVP() {
        ...
        var xhr = new XMLHttpRequest();
        var url = "https://api.npoint.io/19367c072815e26e95a6";
        ...
        xhr.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                var data = JSON.parse(this.responseText);
                localStorage.setItem("RSVPData5a6", this.responseText);
    ...
    document.getElementById("send-messages").addEventListener("click", (e) => {
        ...
        if (document.getElementById('floatingInput').value != '' &&
            ...
            var latestData = JSON.parse(localStorage.getItem("messagesData30c"));
            latestData.data_messages.push(Object.fromEntries(formData));
            request.send(JSON.stringify(latestData));
            localStorage.setItem("messagesData30c", JSON.stringify(latestData));
    ...
    document.getElementById("send-rsvp").addEventListener("click", (e) => {
        ...
        if (document.getElementById('name_input').value != '' &&
            ...
            var latestData = JSON.parse(localStorage.getItem("RSVPData5a6"));
            latestData.data_invitee.push(Object.fromEntries(formData));
            request.send(JSON.stringify(latestData));
            localStorage.setItem("RSVPData5a6", JSON.stringify(latestData));
